...
import 'package:flyme_generator/src/parameters.dart';
...
class FunctionalWidgetGenerator
  ...
  String _getFallbackElementDiagnostic(ParameterElement element) =>
      'DiagnosticsProperty<${element.type.isDartCoreNull ? findBeginToken(element) : element.type.getDisplayString()}>';
  ...
  Iterable<Reference> _parseTypeParemeters(
    ...
    return typeParameters.map((e) {
      return e.bound?.getDisplayString() != null
          ? refer('${e.displayName} extends ${e.bound.getDisplayString()}')
          : refer(e.displayName);
    });
  }
